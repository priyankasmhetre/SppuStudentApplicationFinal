...
import 'package:sppu_student_application/Screens/update_teacher_profile.dart';




class FetchTeacherProfile extends StatefulWidget {
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<FetchTeacherProfile> {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            Padding(
                ...
                child: FlatButton(
                  onPressed: () => _pushPage(context,update_teacher_profile()),
        ...
        Container(
          ...
          child: StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance.collection('TeacherProfile')
                  .snapshots(),
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  ...
                  for (var st in services) {
                    ...
                    final values = buildTile(Name ,Email,ID,BloodGroup,MobNO,context);
  ...
  buildTile(Name,Email,ID,BloodGroup,MobNO,BuildContext context) {
    return ListTile(
