...
class admin_State extends State<adminProfile> {
  ...
  String Adress;
  addData1() {
    Map<String,dynamic> demodata={"Name":Fullname,"Email":Email,"MobNO":MobNO,
      "BloodGroup":BlooG,
    };
    User user=FirebaseAuth.instance.currentUser;
    FirebaseFirestore.instance.collection('AdminProfile').doc(user.uid).set(demodata
