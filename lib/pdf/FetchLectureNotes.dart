...
class FetchLectureNotes extends StatefulWidget {
  @override
  _MainPageState createState() => _MainPageState();
}

class _MainPageState extends State<FetchLectureNotes> {
  @override
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ButtonWidget(
              text: 'View LectureNotes',
              onClicked: () async {
                final url = 'LectureNotes/Small Sample Tests.pdf';
